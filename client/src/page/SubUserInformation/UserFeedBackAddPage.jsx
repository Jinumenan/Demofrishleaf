    ...
    return (
        <div className='bg-slate-200 rounded-lg py-7 w-[500px] h-[500px] mt-5 ml-[500px] p-7'>
            ...
            <form className='addreviewForm' onSubmit={handleSubmit}>
                <div className="mb-4">
                    <label htmlFor="adname" className="text-xl mb-2 block  font-medium text-gray-700">Product Rating</label>
                    <input
                        type="range"
                        min="1"
                        max="5"
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        className='w-80 w-[400px] h-[40px] px-2 rounded-lg bg-green-200'
                    />
                </div>
                <div className="mb-4">
